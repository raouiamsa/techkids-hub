        ...
        <>
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-semibold
                           ...
                           disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/25"
            >
            ...
            <div className="text-center mt-4">
                {canResend ? (
                    <button
                        ...
                        className="flex items-center gap-1.5 mx-auto text-sm text-primary hover:text-primary-hover font-medium transition-colors"
                    >
