...
// Pages where the navbar should be hidden (login, register, etc.)
    ...
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/60 dark:border-slate-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <Link
            href="/courses"
            className="px-4 py-2 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-colors"
          >
            Catalogue de cours
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2">
          {isLoading ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/register"
                className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-semibold rounded-xl shadow transition-all"
              >
                S&apos;inscrire
              </Link>
            </div>
