      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <header className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm p-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <Button asChild className="bg-indigo-600 hover:bg-indigo-700 shadow rounded-xl normal-case tracking-normal font-semibold text-sm">
              <Link href="/courses">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <Button
            ...
            className="w-full border-2 border-dashed border-indigo-300 dark:border-indigo-700 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 normal-case tracking-normal font-semibold text-sm rounded-2xl"
          >
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-indigo-200 dark:border-indigo-800 p-4 space-y-3">
              ...
              <form onSubmit={handleAddChild} className="space-y-2">
                ...
                <Button
                  ...
                  className="w-full bg-indigo-600 hover:bg-indigo-700 normal-case tracking-normal font-semibold text-sm rounded-xl"
                >
                ...
                return (
                  <div key={child.id} className="relative group">
                    ...
                    <Button
                      ...
                      className="absolute top-2 right-2 h-6 w-6 rounded-full bg-red-100 dark:bg-red-900/30 text-red-500 hover:bg-red-200 opacity-0 group-hover:opacity-100 transition-opacity"
                    >
              ...
              {safeChildren.length === 0 ? (
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  ...
                  <Button
                    ...
                    className="bg-slate-900 hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-900 shadow-sm rounded-xl normal-case tracking-normal font-semibold text-sm"
                  >
                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
                    <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-200">
                      ...
                      <div className="px-6 py-4 bg-slate-50 dark:bg-slate-900/80 border-t border-slate-100 dark:border-slate-800 text-right">
                        <Button variant="outline" onClick={() => setShowEnrollModal(false)} className="rounded-xl normal-case tracking-normal font-semibold text-sm">Fermer</Button>
                      </div>
                    </div>
                  </div>
                )}
